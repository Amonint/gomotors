  ...
  return (
    <div id="about-us">
      ...
      <div className="relative min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-6 z-10 flex flex-col md:flex-row py-20 md:py-0">
          ...
          <div className="flex-1">
            <h2 className="text-2xl md:text-4xl text-white font-normal leading-tight mb-6">
      ...
      <section className="bg-white text-black py-16 md:py-32">
        <div className="mx-auto px-4 md:px-8 lg:px-16 max-w-[1600px]">
          ...
          <div className="mb-16 md:mb-24">
            ...
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12 md:col-span-8 lg:col-span-6">
                <h2 className="text-[2rem] md:text-[3.5rem] lg:text-[4.5rem] font-montserrat-medium leading-[1.1] tracking-tight">
            ...
            <div className="col-span-12 md:col-span-6">
              ...
              <div className="grid grid-cols-12 gap-x-4 mb-16 md:mb-24">
                <div className="col-span-2 md:col-span-1 flex flex-col items-start">
                  <div className="h-[80px] md:h-[120px] pt-6 md:pt-12 flex items-start">
                    <span className="text-[3rem] md:text-[5rem] font-montserrat-light text-gray-200">
                      1
                    </span>
                  </div>
                  <div className="w-[1px] h-full bg-gray-200 ml-4 md:ml-6 mt-4"></div>
                </div>

                <div className="col-span-10 md:col-span-11">
                  <div className="pr-4 md:pr-12">
                    <h3 className="text-2xl md:text-4xl mb-8 md:mb-12 font-montserrat-medium tracking-tight uppercase">
                      Misión
                    </h3>
                    <p className="text-base md:text-lg font-montserrat-light leading-relaxed text-gray-700 mb-8 md:mb-12">
              ...
              {/* Vision section */}
              <div className="grid grid-cols-12 gap-x-4 mt-16 md:mt-40">
                <div className="col-span-2 md:col-span-1 flex flex-col items-start">
                  <div className="h-[80px] md:h-[120px] pt-6 md:pt-12 flex items-start">
                    <span className="text-[3rem] md:text-[5rem] font-montserrat-light text-gray-200">
                      2
                  ...
                  <div className="w-[1px] h-[200px] bg-gray-200 ml-4 md:ml-6 mt-4"></div>
                </div>
      ...
      <div className="bg-gray-200 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="border-t border-gray-400 pt-8">
            <h3 className="text-3xl md:text-5xl text-black mb-8 md:mb-12">Nuestros Valores</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mt-8">
            {/* Valor 1 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">01</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
                <h4 className="text-lg md:text-xl font-medium text-black">Respeto</h4>
              </div>
            ...
            {/* Valor 2 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">02</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
            ...
            {/* Valor 3 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">03</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
                <h4 className="text-lg md:text-xl font-medium text-black">Calidad</h4>
              </div>
              <p className="text-sm md:text-base font-light text-black/70">
            ...
            {/* Valor 4 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">04</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
                <h4 className="text-lg md:text-xl font-medium text-black">Honestidad</h4>
              </div>
              <p className="text-sm md:text-base font-light text-black/70">
            ...
            {/* Valor 5 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">05</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
                <h4 className="text-lg md:text-xl font-medium text-black">Rentabilidad</h4>
              </div>
              <p className="text-sm md:text-base font-light text-black/70">
            ...
            {/* Valor 6 */}
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h2 className="text-6xl md:text-9xl font-light text-black mb-4">06</h2>
              <div className="flex items-center mb-4 md:mb-6">
                <div className="w-1 h-6 bg-black mr-3"></div>
                <h4 className="text-lg md:text-xl font-medium text-black">Lealtad</h4>
              </div>
              <p className="text-sm md:text-base font-light text-black/70">
